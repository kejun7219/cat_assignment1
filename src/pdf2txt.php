...
<body>
        ...
        <nav>
            ...
            <div class="navigation">
               <ul> 
                   ...
                   <li><a class="btn active" href="pdf2txt.php"> PDF to TXT</a></li>
        ...
        <section id="home">
        <div class="content">
        <h1> Convert <span id='redword'>PDF</span> To <span id='redword'>TXT</span> </h1>
        <span class="multiText fasttext"></span>
        <div class="container">
            <div class="upload-container">

                <!-- Choose Form -->
                <form method="POST" action="uploadpdf.php" enctype="multipart/form-data" class="upload-form">
                    <!-- Choose File button without the icon -->
                    <label for="file-input" class="button choose-file-button">
                        Choose File
                        <input type="file" id="file-input" name="pdfFiles[]" required accept=".pdf" multiple style="display: none;">
                    </label>
                    <div class="afterbox" style="display: none">
                        <!-- Display the count of uploaded PDF files below the buttons -->
    ...
    <h2> How To Use It </h2>
      <p class="Transform"> 
        Effortlessly convert <span id="redword">PDF</span> to <span id="redword">TXT</span> formats with a few clicks.</p>
     <div class="fea-base"> 
         <div class=" fea-box">
             <i class="fa-solid fa-folder-open" ></i>
             <h3> Select Files in One Go </h3>
             <p> Choose multiple files at once by holding 'Ctrl' (Windows) or 'Command' (Mac) for one-click selection.  </p>
         </div>
         <div class=" fea-box">
             <i class="fa-solid fa-upload"></i>
             <h3> Upload to Convert </h3>
             <p> Click 'Choose File' to select your PDFs, and experience rapid conversion into text format within seconds. </p>
         </div>
         <div class=" fea-box">
           <i class="fa-solid fa-file-archive"></i>
             <h3> Download the Zip File  </h3>
             <p> After conversion, download the zip file to instantly access your converted text documents.</p>
         </div>
     </div>
     </section>
