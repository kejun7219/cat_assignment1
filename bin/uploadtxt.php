...
<body>
    ...
    <section id="page">
        ...
        <p>One Click Away: Download Your Transformed Texts Instantly </p>

        <div class="btn">
            <a class="blue" href="downloadpdf.php"> Download here </a>
        </div>
        <div class="ImgCon">
...
<?php
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["txtFiles"]["tmp_name"])) {
    $targetDir = "upload/";

    // Loop through each uploaded file
    foreach ($_FILES["txtFiles"]["tmp_name"] as $key => $tmp_name){

        // Construct the full path for the destination file where the uploaded file will be moved to
        $targetFile = $targetDir . basename($_FILES["txtFiles"]["name"][$key]);
