var typingEffect = new Typed(".multiText",{
    strings:["Experience the effortless transition of your PDF documents into TXT files with just a click.","All made possible by ConvertEase – your trusted platform for file conversion"],
    loop: true,
    typeSpeed: 20,
    backSpeed: 20,
    backDelay: 5000,
    ...
    document.querySelector('.upload-form').addEventListener('change', function () {
        ...
        document.getElementById('file-count').innerText = 'Number of PDFs chosen: ' + fileCount;
